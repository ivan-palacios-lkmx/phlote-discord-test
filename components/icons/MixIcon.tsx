const MixIcon = (props: React.SVGProps<SVGSVGElement>) => {
  return (
    <svg
      ...
      <path d="M1.5 0.5V9.5" stroke="currentColor" stroke-linecap="round" />
      <circle cx="1.5" cy="8" r="1" stroke="currentColor" />
      <path d="M5 0.5V9.5" stroke="currentColor" stroke-linecap="round" />
      <circle cx="5" cy="5" r="1" stroke="currentColor" />
      <path d="M8.5 0.5V9.5" stroke="currentColor" stroke-linecap="round" />

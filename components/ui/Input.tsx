...
const inputVariants = tv({
  ...
  variants: {
    variant: {
      ...
      outline: "",
      signature: "",
      form: "block w-full box-border border border-black/20 rounded-[10px] px-5 py-5 uppercase mt-[15px] transition-colors focus:border-black disabled:opacity-50 text-base font-sans",
    },
  },
});
